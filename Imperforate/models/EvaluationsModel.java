...
public class EvaluationsModel extends AbstractTableModel {
	...
	private static final ImageMeasure[] MEASURES = new ImageMeasure[] {
		...
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M5()))),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new M6())),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M6()))),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new M7())),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M7()))),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new M8())),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M8()))),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new M9())),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M9()))),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new M10())),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M10()))),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new M11())),
		new GrayscaledImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M11()))),
		...
		new ComponentsImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M5()))),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new M6())),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M6()))),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new M7())),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M7()))),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new M8())),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M8()))),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new M9())),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M9()))),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new M10())),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M10()))),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new M11())),
		new ComponentsImageMeasure(new FuzzyImageMeasure(new ComplementFuzzyMeasure(new M11()))),
		...
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M5()), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M6(), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M6()), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M7(), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M7()), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M8(), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M8()), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M9(), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M9()), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M10(), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M10()), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M11(), new int[] {16, 4, 4})),
		new HsvImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M11()), new int[] {16, 4, 4})),
		...
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M5()), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M6(), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M6()), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M7(), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M7()), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M8(), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M8()), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M9(), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M9()), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M10(), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M10()), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M11(), new int[] {4, 8, 8})),
		new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M11()), new int[] {4, 8, 8})),
...
//		new HmmdImageMeasure(new FuzzyHistogramImageMeasure(new MI3c(), new int[] {16, 4, 4})),
		...
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M5()), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M6(), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M6()), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M7(), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M7()), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M8(), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M8()), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M9(), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M9()), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M10(), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M10()), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M11(), new int[] {4, 8, 8})),
		new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M11()), new int[] {4, 8, 8})),
		...
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M5()), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M6(), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M6()), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M7(), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M7()), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M8(), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M8()), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M9(), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M9()), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M10(), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M10()), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M11(), new int[] {8, 4, 8})),
		new XyzImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M11()), new int[] {8, 4, 8})),
		...
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M5()), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M6(), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M6()), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M7(), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M7()), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M8(), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M8()), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M9(), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M9()), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M10(), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M10()), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M11(), new int[] {4, 8, 8})),
		new YxyImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M11()), new int[] {4, 8, 8})),
		...
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M1a(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M1b(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M1c(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M2(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M3(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M5(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M5()), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M6(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M6()), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M7(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M7()), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M8(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M8()), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M9(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M9()), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M10(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M10()), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M11(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M11()), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M12(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M13(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {7, 7, 7})),
		new LabImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3c(), new int[] {7, 7, 7})),
		...
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M5()), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M6(), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M6()), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M7(), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M7()), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M8(), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M8()), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M9(), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M9()), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M10(), new int[] {11})),
		new FocalImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M11()), new int[] {11})),
		...
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M1a(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M1b(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M1c(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M2(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M3(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M5(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M5()), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M6(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M6()), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M7(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M7()), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M8(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M8()), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M9(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M9()), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M10(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M11()), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M11(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new ComplementFuzzyMeasure(new M11()), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M12(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M13(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256})),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3c(), new int[] {256})),
		
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 6, 250),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 7, 249),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 8, 248),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 9, 247),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 10, 246),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 11, 245),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 12, 244),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 13, 243),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 14, 242),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 15, 241),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 16, 240),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 20, 236),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 30, 226),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 40, 216),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), new int[] {256}), 50, 206),
		
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M1a(), new int[] {256}, 
				new SctSmoother(16,240)), 16, 240),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M1b(), new int[] {256}, 
				new SctSmoother(16,240)), 16, 240),
		new SctImageMeasure(new PseudoFuzzyHistogramImageMeasure(new M1c(), new int[] {256}, 
				new SctSmoother(16,240)), 16, 240),
		...
		new FuzzyHistogramImageMeasure(new MI3()),
			...
			new ProductImageMeasure(
					new IrbImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), 500)),
					new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), 15))),
			new ProductImageMeasure(
					new GrayscaledImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), 256)),
					new I1i2i3ImageMeasure(new PseudoFuzzyHistogramImageMeasure(new MI3(), 15))),
