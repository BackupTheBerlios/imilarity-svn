...
Door op een beeld
uit de zoekresultaten te klikken en vervolgens ``Add to examples'' te kiezen,
...
we het minimum -- of een andere t-conorm -- zouden gebruiken, dan zouden we eisen
...
\caption{\label{fig:tests_banaan_1}De eerst tien beelden van de rangschikkingen van de zoekresultaten voor ``banaan'' 
...
\caption{\label{fig:tests_banaan_2}De eerst tien beelden van de rangschikkingen van de zoekresultaten voor ``banaan'' 
...
\caption{\label{fig:tests_banaan_3}De eerst tien beelden van de rangschikkingen van de zoekresultaten voor ``banaan'' 
