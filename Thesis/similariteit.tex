...
in partities. Deze partities kunnen een verschillend aantal beeldonderdelen bevatten, maar alle 
onderdelen moeten wel dezelfde resolutie hebben. Elk beeldonderdeel kan dan opgevat worden als een 
klein beeld waarop we de reeds geziene pixel-gebaseerde similariteitsmaten kunnen toepassen.
...
beeldonderdeel gelijk aan de gemiddelde kleur van dat onderdeel. De similariteiten
die berekend worden in de derde stap zijn in dit geval de volgende: 
\begin{center}
\begin{tabular}{c|cccccccccc}
		& $B_1$ & $B_2$ & $B_3$ & $B_4$ & $B_5$ & $B_6$ & $B_7$ & $B_8$ & $B_9$  \\
\hline
$A_1$ 	& $\mathbf{0.5198}$ & $0.4496$ \\
$A_2$ 	& & $\mathbf{0.4691}$ & $0.3859$ \\
$A_3$ 	& & & $0.4133$ & $\mathbf{0.4404}$ & $0.3298$ \\
$A_4$ 	& & & & & $0.3277$ & $\mathbf{0.4330}$ & $0.3648$ \\
$A_5$ 	& & & & & & & $\mathbf{0.3849}$ & $0.3134$ \\
$A_6$ 	& & & & & & & & $\mathbf{0.3438}$ & $0.3427$ \\
$A_7$ 	& & & & & & & & & $\mathbf{0.5066}$ \\
\end{tabular}
\end{center}
In deze tabel staan de similariteiten die worden toegevoegd aan $S$ in het vet. Deze similariteiten 
