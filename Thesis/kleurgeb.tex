...
verwachten dat die \definas{kleurgebaseerde similariteitsmaat}{kleurgebaseerde} aanpak effici\"ente 
similariteitsmaten zal opleveren. 

\section{Histogrammen}

De waarde van het \defin{histogram} voor een kleurbeeld 
...
met de corresponderende histogrammen (van links naar rechts: HSV, Irb, XYZ, Yxy, L*a*b*, 
focale kleuren, SCT en vaag).}
\end{figure}
...
andere plaats. Er geldt dus $\mathcal{H}_A \setminus \mathcal{H}_B = \mathcal{H}_A \cap \mathcal{H}^c_B=\mathcal{H}_A$
en ook $\mathcal{H}_B \setminus \mathcal{H}_A = \mathcal{H}_B$. Bovendien
geldt dan
...
door \definas{uitgebreid histogram}{uitgebreide histogrammen} te beschouwen. 
...
\definas{centrumhistogram}{centrumhistogrammen}. Figuur~\ref{fig:constructie_centrumhistogrammen} illustreert
...
\label{fig:constructie_centrumhistogrammen}
}
\qquad
\subfigure[]{
...
We kunnen ook een glad centrumhistogram construeren. Dat doen we door
...
We noemen de histogrammen die we zo bekomen \definas{randhistogram}{randhistogrammen}. 
...
Bij de pixelgebaseerde similariteitsmaten uit het vorige hoofdstuk, vormen de beeldpunten
