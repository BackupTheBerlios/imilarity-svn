...
tussen twee constrasterende kleuren voorstelt (rood-groen, geel-blauw en zwart-wit).
...
waarbij 
\begin{displaymath}
col_i(n) = \frac{n-1}{\prod_{j=1}^i N_j} + \frac{1}{2 \cdot N_i}
\end{displaymath} 
voor alle $n \in \{1,2,\ldots,N\}$ en $i \in \{1,2,\ldots,l\}$. Figuur~\ref{fig:bin_en_col}
...
\vspace{10pt}
\caption{\label{fig:bin_en_col}Illustratie van $bin$ en $col$ voor $l=1$ en $N=1$.}
\end{figure}
