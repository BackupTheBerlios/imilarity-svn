...
\begin{center}
\subfigure[]{
\includegraphics[width=0.4\textwidth]{plots/neuquant_vs_wu_small_filled.eps}
\label{fig:neuquant_vs_wu_small}
}
\subfigure[]{
\includegraphics[width=0.4\textwidth]{plots/neuquant_vs_wu_big_filled.eps}
\label{fig:neuquant_vs_wu_big}
}
