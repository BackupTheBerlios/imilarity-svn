...
\centering
\subfigure[]{
\includegraphics[width=0.48\textwidth]{images/t_m.eps}
}
\subfigure[]{
\includegraphics[width=0.48\textwidth]{images/s_m.eps}
}
\subfigure[]{
\includegraphics[width=0.48\textwidth]{images/t_p.eps}
}
\subfigure[]{
\includegraphics[width=0.48\textwidth]{images/s_p.eps}
}
\vspace{5pt}
...
conjunctieve, disjunctieve, compenserende, niet-compenserende en gewogen operatoren.
