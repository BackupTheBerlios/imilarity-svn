...
het internet rond om bepaalde documenten -- in het bijzonder beelden -- te localiseren. Deze 
...
om manieren te zoeken om deze gigantische collecties van beelden op een effeci\"ente wijze
te doorzoeken.
...
Figuur~\ref{fig:tbir} toont de algemene architectuur van deze machines. Elk beeld 
wordt voorzien van tekstuele annotaties, zoals bijvoorbeeld de 
bestandsnaam of woorden uit de webpagina waarvan het deel uitmaakt. Deze annotaties
...
deel uit van het resultaat van de query. Men hoeft hiervoor uiteraard niet alle beelden
...
\emph{(visual) feature extraction} genoemd wordt \cite{rui:image_retr}. Dit proces zet een beeld om in een 
...
gebruiker een voorbeeld-beeld opgeeft, waarna het systeem op zoek gaat naar beelden
die visuele gelijkenissen vertonen met dit voorbeeld. Hiervoor wordt eerst de feature vector van
het opgegeven beeld bepaald, om deze vervolgens te vergelijken met de kenmerkenvectoren in
...
voorbeeld-beeld. Doordat de databank ge\"indexeerd is op de kenmerkenvectoren, kan men 
...
een geschikt voorbeeld. Dit probleem kan eventueel nog opgelost worden door gebruik
...
de mogelijkheid om een verzameling van voorbeeld-beelden te kiezen uit deze lijst. Het 
