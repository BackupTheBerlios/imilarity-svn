...
\hyphenation{Ha-da-mard-trans-for-ma-tie Fourier-transformatie post-script} 
...
\input{titel} % de titelpagina
\pagenumbering{roman}
\setcounter{page}{1}
\input{dankwrd}               %het dankwoord.
\input{abstract}              %samenvatting  van de thesis
