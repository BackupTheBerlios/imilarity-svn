...
public class ProductImageMeasure2 extends ImageMeasureBase {

	private ImageMeasure measure1, measure2;
	
	public ProductImageMeasure2(ImageMeasure measure1, ImageMeasure measure2) {
		if (measure1 == null)
	...
	public double getSimilarity() {
		return measure1.getSimilarity() * measure2.getSimilarity();
	}

	public String getDescription() {
		return "Product2 of " + measure1.getDescription() + " and " + measure2.getDescription(); 
	}
